...
(function () {
  ...
  // V2
  // filtering
  var filterTodosByStatus = function filterTodosByStatus() {
  ...
  var countCompletedTodos = function countCompletedTodos() {
    return todos.filter(function (todo) {
      return todo.completed;
    }).length;
  };

  var countLeftTodos = function countLeftTodos() {
    return todos.filter(function (todo) {
      return !todo.completed;
    }).length;
  };
  ...
  var generateTodoId = function generateTodoId() {
    return todos.length ? Math.max.apply(Math, _toConsumableArray(todos.map(function (_ref3) {
      var id = _ref3.id;
      return id;
    }))) + 1 : 1;
  };

  var TodoGet = function TodoGet() {
    // done
    _axios2.default.get('/todos').then(function (_ref4) {
      var data = _ref4.data;
  ...
  var addTodo = function addTodo(content) {
    var todo = { id: generateTodoId(), content: content, completed: false };
  ...
  var toggleTodoComplete = function toggleTodoComplete(id) {
    var toggleItem = 'toggle item not yet';
  ...
  var toggleTodoAllComplete = function toggleTodoAllComplete(chkStatus) {
    todos = todos.map(function (todo) {
  ...
  var removeCompletedTodo = function removeCompletedTodo() {
    todos = todos.filter(function (todo) {
      return !todo.completed;
    });
    TodoCompleteAll();
  ...
  todoList.addEventListener('change', function (e) {
    return toggleTodoComplete(e.target.id);
  });
  ...
  document.querySelector('.nav').addEventListener('click', function (e) {
    ...
    [].concat(_toConsumableArray(this.childNodes)).forEach(function (nav) {
      // Skip text node
      if (nav.nodeName === 'LI') {
